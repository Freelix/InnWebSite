...
<!-- Haut de page -->
<head>
    <title>Activités - Rabais - Auberge Internationale de Trois-Rivières</title>
...
<body>
    ...
    <div id="header">
	  ...
	  <a href="http://www.facebook.com/pages/Auberge-de-jeunesse-HI-Trois-Rivi%C3%A8res/180609951984544"><img id="facebook_logo" src="style/facebook.png" alt="facebook"/></a>
        <ul id="menu"> 
          ...
          <li class="tab_selected"><a href="activites.php">Activités<img class="downarrowclass" style="border:0;" src="style/Dropdown/down.gif"/></a>
			<ul id="menu_dropdown">
  ...
  <li id="menu_dropdown"><a href="multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
	  <h1>Activités - Rabais</h1>
       <?php
			//Requête
			$reponse = $bdd->query('SELECT * FROM activite_rabais');
			
			//Affichage
			while ($donnees = $reponse->fetch())
			{
				$noAct = $donnees['no_activite'];
				$reponseRabais = $bdd->query("SELECT * FROM rabais_rabais_membre WHERE no_activite = $noAct");
				$countRabais = $bdd->query("SELECT COUNT(*) FROM rabais_rabais_membre WHERE no_activite = $noAct");

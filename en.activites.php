...
<!-- Haut de page -->
<head>
    <title>Activities at the hostel - Youth Hostel, Trois Rivieres</title>
...
<body>
  ...
  <li id="menu_dropdown"><a href="en.multimedia_tr.php">Pictures Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
	  <h1>Activities at the hostel</h1>
       <?php
			//Requête
			...
			while ($donnees = $reponse->fetch())
			{
				...
				$reponseRabais = $bdd->query("SELECT * FROM en_rabais_membre WHERE no_activite = $noAct");
				$countRabais = $bdd->query("SELECT COUNT(*) FROM en_rabais_membre WHERE no_activite = $noAct");

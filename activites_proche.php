...
<!-- Haut de page -->
<head>
    <title>Activités à proximité - Auberge Internationale de Trois-Rivières</title>
	  ...
	  <h1>Activités à proximité</h1>
       <?php
			...
			while ($donnees = $reponse->fetch())
			{
				...
				$reponseRabais = $bdd->query("SELECT * FROM rabais_proche_membre WHERE no_activite = $noAct");
				$countRabais = $bdd->query("SELECT COUNT(*) FROM rabais_proche_membre WHERE no_activite = $noAct");

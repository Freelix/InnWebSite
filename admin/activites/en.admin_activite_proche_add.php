    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		?>
			...
			<h1 class="blue">Activités à proximité - Ajout - Anglais</h1>
			
			<form name="input" action="../../php/activite/en.activite_proche_add.php" method="post" enctype="multipart/form-data">

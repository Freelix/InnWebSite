...
<body>
  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		<?php
		$reponse = $bdd->query('SELECT * FROM rabais');
		?>
			<a class="orange" href="../admin_main_page.php">Retour au menu</a>
			<h1 class="blue">Activités - Modification/Suppression</h1>
			...
			<table id="tab_reserv">
				...
				<tr>
					...
					<td><a href="admin_modification.php?id=<?php echo $data['no_activite'];?>"><img id="btn_edit_supp" src="../../style/edit.png" alt="modifier"/></a></td>
					<td><a href="../../php/activite/activite_del.php?id=<?php echo $data['no_activite'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			</table>
			
			<form name="input" action="../../php/activite/activite_add.php" method="post" enctype="multipart/form-data">

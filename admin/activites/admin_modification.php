  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		<?php
		$id = $_GET['id'];
		$reponse = $bdd->query("SELECT * FROM activite WHERE no_activite = $id");
		?>
		...
		<?php 
			...
			{
		?>
			<form name="input" action="../../php/activite/activite_mod.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
			...
			<?php $query = $bdd->query("SELECT * FROM rabais_membre WHERE no_activite = $id"); 
				  $count = $bdd->query("SELECT * FROM rabais_membre WHERE no_activite = $id");
				  $nbrRabais = 0;
			...
			<form name="input" action="../../php/activite/rabais_add.php?id=<?php echo $id;?>" method="post">
				<h2>Rabais</h2>

...
<body>
  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		<?php
		$reponse = $bdd->query('SELECT * FROM en_rabais');
		?>
			<a class="orange" href="../en.admin_main_page.php">Retour au menu</a>
			<h1 class="blue">Activités - Modification/Suppression - Anglais</h1>
			...
			<table id="tab_reserv">
				...
				<?php
					...
					{ ?>
				<tr>
					<td><?php echo $data['titre_activite'];?></td>
					<td><a href="en.admin_modification.php?id=<?php echo $data['no_activite'];?>"><img id="btn_edit_supp" src="../../style/edit.png" alt="modifier"/></a></td>
					<td><a href="../../php/activite/en.activite_del.php?id=<?php echo $data['no_activite'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			</table>
			
			<form name="input" action="../../php/activite/en.activite_add.php" method="post" enctype="multipart/form-data">

    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		?>
			...
			<h1 class="blue">Activités rabais - Modification/Suppression</h1>
			...
			<table id="tab_reserv">
				...
				<tr>
					...
					<td><a href="admin_rabais_modification.php?id=<?php echo $data['no_activite'];?>"><img id="btn_edit_supp" src="../../style/edit.png" alt="modifier"/></a></td>
					<td><a href="../../php/activite/activite_rabais_del.php?id=<?php echo $data['no_activite'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			</table>

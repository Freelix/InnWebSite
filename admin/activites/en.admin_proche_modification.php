  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		<?php
		$id = $_GET['id'];
		$reponse = $bdd->query("SELECT * FROM en_activite_proche WHERE no_activite = $id");
		?>
		...
		<?php 
			...
			{
		?>
			<form name="input" action="../../php/activite/en.activite_proche_mod.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
			...
			<?php $query = $bdd->query("SELECT * FROM en_rabais_proche_membre WHERE no_activite = $id"); 
				  $count = $bdd->query("SELECT * FROM en_rabais_proche_membre WHERE no_activite = $id");
				  $nbrRabais = 0;
			...
			<table id="tab_reserv">
				...
				<tr>
					...
					<td><a href="../../php/activite/en.rabais_proche_del.php?id=<?php echo $dataRabais['no_rabais'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			...
			<form name="input" action="../../php/activite/en.rabais_proche_add.php?id=<?php echo $id;?>" method="post">
				<h2>Rabais</h2>

    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		?>
			...
			<h1 class="blue">Activités à proximité - Modification/Suppression</h1>
			...
			<table id="tab_reserv">
				...
				<tr>
					...
					<td><a href="admin_proche_modification.php?id=<?php echo $data['no_activite'];?>"><img id="btn_edit_supp" src="../../style/edit.png" alt="modifier"/></a></td>
					<td><a href="../../php/activite/activite_proche_del.php?id=<?php echo $data['no_activite'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			</table>

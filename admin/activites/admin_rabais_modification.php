  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		<?php
		$id = $_GET['id'];
		$reponse = $bdd->query("SELECT * FROM activite_rabais WHERE no_activite = $id");
		?>
			<a class="orange" href="../admin_main_page.php">Retour au menu</a>
			<h1 class="blue">Activités Rabais - Modification</h1>
			
		<?php 
			while ($data = $reponse->fetch())
			{
		?>
			<form name="input" action="../../php/activite/activite_rabais_mod.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
			...
			<?php $query = $bdd->query("SELECT * FROM rabais_rabais_membre WHERE no_activite = $id"); 
				  $count = $bdd->query("SELECT * FROM rabais_rabais_membre WHERE no_activite = $id");
				  $nbrRabais = 0;
			...
			<table id="tab_reserv">
				...
				<tr>
					...
					<td><a href="../../php/activite/rabais_rabais_del.php?id=<?php echo $dataRabais['no_rabais'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			...
			<form name="input" action="../../php/activite/rabais_rabais_add.php?id=<?php echo $id;?>" method="post">
				<h2>Rabais</h2>

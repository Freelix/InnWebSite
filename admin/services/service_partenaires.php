		...
		?>
			...
			<table id="tab_reserv">
				...
				<tr>
					...
					<td><a href="../../php/services/partenaire_del.php?id=<?php echo $data['no_partenaire'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			</table>
			
			<form name="input" action="../../php/services/partenaire_add.php" method="post" enctype="multipart/form-data">
				<p><br/></p>
				<h2>Partenaire</h2>

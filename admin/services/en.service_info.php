...
<body>
  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		<form name="input" action="../../php/services/en.info_mod.php" method="post">
			...
			{
			?>
			<h1 class="blue">Services - Informations - Anglais</h1>
	
			<h2>Informations</h2>
			<textarea id="area_design" name="info"><?php echo $data['desc_service'];?></textarea>
			<?php } ?>

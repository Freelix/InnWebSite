...
<body>
  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		<?php
		$reponse = $bdd->query('SELECT * FROM liste_service');
		?>
			...
			<table id="tab_reserv">
				...
				<tr>
					...
					<td><a href="../../php/services/liste_del.php?id=<?php echo $data['no_service'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			</table>
			
			<form name="input" action="../../php/services/liste_add.php" method="post">
				<p><br/></p>
				<h2>Service</h2>

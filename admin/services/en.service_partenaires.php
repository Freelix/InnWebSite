    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		?>
			...
			<h1 class="blue">Services - Liste des services - Anglais</h1>
			...
			<table id="tab_reserv">
				...
				<?php
					...
					{ ?>
				<tr>
					<td><?php echo $data['nom_partenaire'];?></td>
					<td><a href="../../php/services/en.partenaire_del.php?id=<?php echo $data['no_partenaire'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			</table>
			
			<form name="input" action="../../php/services/en.partenaire_add.php" method="post" enctype="multipart/form-data">
				<p><br/></p>
				<h2>Partenaire</h2>

  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		<h1 class="blue">Nombre de pages</h1>

		<form name="input" action="../../php/multimedia/multi_nbrpictures.php?" method="post">
			<?php
			$reponse = $bdd->query("SELECT * FROM autres");
			while ($data = $reponse->fetch())
			{ ?>
			
			<h2>Nombre de photos par page - Auberge</h2>
			<input id="titre_design" type="text" name="nbr_auberge" value="<?php echo $data['nbr_pictures_auberge']; ?>"/>
			
			<h2>Nombre de photos par page - Trois-Rivières</h2>
			<input id="titre_design" type="text" name="nbr_tr" value="<?php echo $data['nbr_pictures_tr']; ?>"/>

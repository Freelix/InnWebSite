  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		<h1 class="blue">Photos de l'auberge</h1>
			
			<?php
				$query = $bdd->query('SELECT COUNT(*) FROM multimedia WHERE section_multi = "Auberge"');
		...
		<form name="input" action="../../php/multimedia/auberge_add.php" method="post" enctype="multipart/form-data">
			<h2>Nom Français</h2>

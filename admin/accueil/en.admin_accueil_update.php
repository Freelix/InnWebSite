  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		<form name="input" action="../../php/en.accueil_update.php?id=<?php echo $id;?>" method="post">
			<?php 
			$reponse = $bdd->query('SELECT * FROM en_page_accueil WHERE no_nouvelle = '. $id .'');
			
			while ($data = $reponse->fetch())
			{
			?>
			<h1 class="blue">Accueil - Modification - Anglais</h1>
			<h2>Titre</h2>
			<input id="titre_design" type="text" name="titre" value="<?php echo $data['titre_nouvelle'];?>"/>
			
			<h2>Description</h2>
			<textarea id="area_design" name="description"><?php echo $data['desc_nouvelle'];?></textarea>

...
<body>
  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		<?php
		$reponse = $bdd->query('SELECT * FROM en_page_accueil');
		?>
			<a class="orange" href="../en.admin_main_page.php">Retour au menu</a>
			<h1 class="blue">Accueil - Modification/Suppression - Anglais</h1>
			...
			<table id="tab_reserv">
				...
				<?php
					while ($data = $reponse->fetch())
					{ 
					 $noo = $data['no_nouvelle'];
					?>
				<tr>
					<td><?php echo $data['titre_nouvelle'];?></td>
					<td><a href="en.admin_accueil_update.php?id=<?php echo $data['no_nouvelle'];?>"><img id="btn_edit_supp" src="../../style/edit.png" alt="modifier"/></a></td>
					<td><a href="../../php/en.accueil_delete.php?id=<?php echo $data['no_nouvelle'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			</table>

  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		<form name="input" action="../../php/accueil_update.php?id=<?php echo $id;?>" method="post">
			<?php 
			$reponse = $bdd->query('SELECT * FROM page_accueil WHERE no_nouvelle = '. $id .'');
			
			while ($data = $reponse->fetch())
			{
			?>
			<h1 class="blue">Accueil - Modification</h1>
			<h2>Titre</h2>

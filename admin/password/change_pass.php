    ...
    <div id="header">
	  ...
	  <a href="http://www.facebook.com/pages/Auberge-de-jeunesse-HI-Trois-Rivi%C3%A8res/180609951984544"><img id="facebook_logo" src="../../style/facebook.png" alt="facebook"/></a>
        <ul id="menu"> 
          ...
          <li><a href="../../activites.php">Activités</a>
			<ul id="menu_dropdown">
    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		?>
			...
			<h1 class="blue">Changer le mot de passe</h1>
			
			<form name="input" action="../../php/password/change.php" method="post">
				<h2>Mot de passe actuel</h2>
				<input id="titre_design" type="password" name="actuel" value="<?php if (isset($_SESSION['nom'])){echo $_SESSION['nom'];}?>"/>
				
				<h2>Nouveau mot de passe</h2>
				<input id="titre_design" type="password" name="nouveau1" value="<?php if (isset($_SESSION['nom'])){echo $_SESSION['nom'];}?>"/>
				
				<h2>Réécrire le mot de passe</h2>
				<input id="titre_design" type="password" name="nouveau2" value="<?php if (isset($_SESSION['nom'])){echo $_SESSION['nom'];}?>"/>

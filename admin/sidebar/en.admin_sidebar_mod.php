  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
	  ...
	  <?php
		...
		while ($dataside = $reponse->fetch())
		{
	  ?>
		<a class="orange" href="../en.admin_main_page.php">Retour au menu</a>
		<form name="input" action="../../php/en.sidebar_update.php" method="post">
			<h1 class="blue">Sidebar - Modification - Anglais</h1>
			<h2>Titre principal</h2>
			<input id="titre_design" type="text" name="titre_general" value="<?php echo $dataside['titre_sidebar']; ?>"/>
			
			<h2>Titre secondaire</h2>
			<input id="titre_design" type="text" name="titre_new" value="<?php echo $dataside['titre_new']; ?>"/>
			
			<h2>Informations du haut</h2>
			<textarea id="area_design" name="desc_new"><?php echo $dataside['info_new']; ?></textarea>
			
			<h2>Titre information</h2>
			<input id="titre_design" type="text" name="titre_info" value="<?php echo $dataside['info_sidebar_titre']; ?>"/>
			
			<h2>Informations du bas</h2>
			<textarea id="area_design" name="desc_info"><?php echo $dataside['info_sidebar_desc']; ?></textarea>

...
<body>
  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		<?php
		$reponse = $bdd->query('SELECT * FROM lien_utile');
		?>
			...
			<table id="tab_reserv">
				...
				<tr>
					...
					<td><a href="../../php/sidebar/lien_utile_delete.php?id=<?php echo $data['no_lien_utile'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			</table>
			
			<form name="input" action="../../php/sidebar/lien_utile_add.php" method="post">
				<p><br/></p>
				<h2>Nom</h2>

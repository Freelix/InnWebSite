    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		?>
			...
			<h1 class="blue">À propos de nous - Nous contacter</h1>
			...
			<table id="tab_reserv">
				...
				<tr>
					...
					<td><a href="admin_about_contact_mod.php?id=<?php echo $data['no_info_contact'];?>"><img id="btn_edit_supp" src="../../style/edit.png" alt="modifier"/></a></td>
					<td><a href="../../php/contact_us/contact_us_del.php?id=<?php echo $data['no_info_contact'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			</table>
			
		<form name="input" action="../../php/contact_us/contact_us_add.php" method="post">

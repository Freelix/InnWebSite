  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		<h1 class="blue">Nous contacter - Modifications - Anglais</h1>

		<form name="input" action="../../php/contact_us/en.contact_us_mod.php?id=<?php echo $id ?>" method="post">
			<?php
			$reponse = $bdd->query("SELECT * FROM en_contact_us WHERE no_info_contact = $id");
			while ($data = $reponse->fetch())
			{ ?>
			
			<h2>Nom</h2>
			<input id="titre_design" type="text" name="nom" value="<?php echo $data['nom_info_contact']; ?>"/>
			
			<h2>Informations</h2>
			<textarea id="area_design" name="desc"><?php echo $data['desc_info_contact']; ?></textarea>

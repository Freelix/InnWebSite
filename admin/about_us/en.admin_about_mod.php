  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		<h1 class="blue">À propos de nous - Anglais</h1>
		...
		<table id="tab_reserv">
				...
				{ ?>
				<tr>
					<td><?php echo $data['nom_employe'];?></td>
					<td><a href="en.admin_about_update.php?id=<?php echo $data['no_employe'];?>"><img id="btn_edit_supp" src="../../style/edit.png" alt="modifier"/></a></td>
					<td><a href="../../php/employe/en.employe_del.php?id=<?php echo $data['no_employe'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
		</table>
		<h1 class="blue">Ajout</h1>
		<form name="input" action="../../php/employe/en.employe_add.php" method="post" enctype="multipart/form-data">
			<h2>Nom</h2>

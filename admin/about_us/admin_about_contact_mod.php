  ...
  <li id="menu_dropdown"><a href="../../multimedia_tr.php">Photos de Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		<h1 class="blue">Nous contacter - Modifications</h1>

		<form name="input" action="../../php/contact_us/contact_us_mod.php?id=<?php echo $id ?>" method="post">
			<?php
			$reponse = $bdd->query("SELECT * FROM contact_us WHERE no_info_contact = $id");
			while ($data = $reponse->fetch())
			{ ?>

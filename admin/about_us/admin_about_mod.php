      ...
      <div id="content">
		...
		<table id="tab_reserv">
				...
				<tr>
					...
					<td><a href="admin_about_update.php?id=<?php echo $data['no_employe'];?>"><img id="btn_edit_supp" src="../../style/edit.png" alt="modifier"/></a></td>
					<td><a href="../../php/employe/employe_del.php?id=<?php echo $data['no_employe'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
		</table>
		<h1 class="blue">Ajout</h1>
		<form name="input" action="../../php/employe/employe_add.php" method="post" enctype="multipart/form-data">
			<h2>Nom</h2>

    ...
    <div id="header">
	 ...
	 <a href="http://www.facebook.com/pages/Auberge-de-jeunesse-HI-Trois-Rivi%C3%A8res/180609951984544"><img id="facebook_logo" src="../../style/facebook.png" alt="facebook"/></a>
        <ul id="menu"> 
		  ...
		  <li><a href="../../en.multimedia_auberge.php">Galerie</a>
		  <ul id="menu_dropdown">
    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		?>
			...
			<h1 class="blue">À propos de nous - Nous contacter - Anglais</h1>
			...
			<table id="tab_reserv">
				...
				<?php
					...
					{ ?>
				<tr>
					<td><?php echo $data['nom_info_contact'];?></td>
					<td><a href="en.admin_about_contact_mod.php?id=<?php echo $data['no_info_contact'];?>"><img id="btn_edit_supp" src="../../style/edit.png" alt="modifier"/></a></td>
					<td><a href="../../php/contact_us/en.contact_us_del.php?id=<?php echo $data['no_info_contact'];?>"><img id="btn_edit_supp" src="../../style/supprimer.gif" alt="supprimer"/></td>
				</tr>
				<?php } ?>
			</table>
			
		<form name="input" action="../../php/contact_us/en.contact_us_add.php" method="post">
				<h1 class="blue">Ajout</h1>
				<h2>Titre</h2>
				<input id="titre_design" type="text" name="titre" value="<?php if (isset($_SESSION['titre'])){ echo $_SESSION['titre'];}?>"/>
				
				<h2>Informations</h2>
				<textarea id="area_design" name="infos"><?php if (isset($_SESSION['infos'])){ echo $_SESSION['infos'];}?></textarea>

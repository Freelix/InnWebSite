...
<!-- Haut de page -->
<head>
    <title>Nearby activities - Youth Hostel, Trois Rivieres</title>
	  ...
	  <h1>Nearby activities</h1>
       <?php
			...
			while ($donnees = $reponse->fetch())
			{
				...
				$reponseRabais = $bdd->query("SELECT * FROM en_rabais_proche_membre WHERE no_activite = $noAct");
				$countRabais = $bdd->query("SELECT COUNT(*) FROM en_rabais_proche_membre WHERE no_activite = $noAct");

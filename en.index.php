...
<!-- Haut de page -->
<head>
    <title>Home - Youth Hostel, Trois Rivieres</title>
    ...
    <div id="header">
	  ...
	  <a href="http://www.facebook.com/pages/Auberge-de-jeunesse-HI-Trois-Rivi%C3%A8res/180609951984544"><img id="facebook_logo" src="style/facebook.png" alt="facebook"/></a>
        <ul id="menu"> 
          ...
          <li class="tab_selected"><a href="en.index.php">Home</a></li>
  ...
  <li id="menu_dropdown"><a href="en.multimedia_tr.php">Pictures Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <h1>Welcome to the International youth hostel's website</h1>
		<?php
			//Requête
			...
			{
				$text = $donnees['desc_nouvelle'];
				
				?>
				<h2><?php echo $donnees['titre_nouvelle'];?></h2>
				
				<p><?php echo nl2br($text); ?><br/></p>
				<?php
			}
			?>
      </div>

<?php
	...
	//Tester si tout est remplis
		...
		if (!EMPTY($_POST['titre']) and !EMPTY($_POST['description']))
		{
			...
			//Requête
			mysql_query("INSERT INTO en_page_accueil VALUES(null, '$titre','$description')") or die("La connexion a échoué.");
	...
	header("location:../admin/accueil/en.admin_accueil_ajout.php");
?>
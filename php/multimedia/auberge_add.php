<?php
	...
	{
		if (file_exists("../../multimedia/Auberge/" . $_FILES["file"]["name"]))
		  {
			null;
		  }
		else
		  {
			move_uploaded_file($_FILES["file"]["tmp_name"], "../../multimedia/Auberge/" . $_FILES["file"]["name"]);
		  }
		...
		if (!EMPTY($_POST['nom']) and !EMPTY($_POST['nom_en']))
		{
			...
			//Requête
			mysql_query("INSERT INTO multimedia VALUES(null, 'multimedia/Auberge/$image', '$nom', 'Auberge', '$nom_en')") or die("La connexion a échoué.");

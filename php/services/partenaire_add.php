<?php
	...
	|| ($_FILES["file"]["type"] == "image/pjpeg"))
	{
		...
		if (!EMPTY($_POST['nom']) and !EMPTY($_POST['lien']))
		{
			...
			//Requête
			mysql_query("INSERT INTO liste_partenaires VALUES(null,'$nom', '$lien', 'multimedia/partenaire/$image')") or die("La connexion a échoué.");
	...
	header("location:../../admin/services/service_partenaires.php");
?>
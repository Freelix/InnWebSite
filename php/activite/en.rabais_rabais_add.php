<?php
	...
	if (!EMPTY($_POST['nom_rabais']))
		{
			...
			//Requête
			mysql_query("INSERT INTO en_rabais_rabais_membre VALUES(null, $id, '$nom_rabais')") or die("La connexion a échoué.");
	...
	header("location:../../admin/activites/en.admin_activite_rabais_mod.php");
?>
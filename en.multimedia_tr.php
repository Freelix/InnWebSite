...
<!-- Haut de page -->
<head>
    <title>Pictures of Trois-Rivieres - Youth Hostel, Trois Rivieres</title>
  ...
  <li id="menu_dropdown"><a href="en.multimedia_tr.php">Pictures Trois-Rivières</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <h1 id="titre_photo">Pictures Trois-Rivières</h1>
		<p><br/></p>
		<div id="images_multi">
		...
		<!-- Section du bas pour changer de page -->
			<div id="page_bas">
				<?php
					...
					?>
					<a href="en.multimedia_tr.php?action=galerie&page=<?php echo $i; ?>"><?php echo $i?></a>
					<?php
					}
					echo ", ";
					}

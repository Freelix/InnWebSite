...
<!-- Haut de page -->
<head>
  <title>Photos de l'auberge - Auberge Internationale de Trois-Rivières</title>
    ...
    <div id="site_content">
     <div class="sidebar">
      ...
      <div id="content">
        ...
        <h1 id="titre_photo">Photos de l'auberge</h1>
		<p><br/></p>
		<div id="images_multi">
		...
		<!-- Section du bas pour changer de page -->
			<div id="page_bas">
				<?php
					...
					?>
					<a href="multimedia_auberge.php?action=galerie&page=<?php echo $i; ?>"><?php echo $i?></a>
					<?php
					}
					echo ", ";
					}
